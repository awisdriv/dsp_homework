...
# 读取图像
image = cv2.imread(r'D:\workstation\sam\segment-anything-main\image\cat.png')
if image is None:
	print("错误：无法读取图像文件")
	exit()
...
#cat 1080,1090       830,774,1265,1336
# 点坐标
point_x, point_y = 1080,1090 
input_points = np.array([[point_x, point_y]])
input_labels = np.array([1])

# 框坐标
box_x1, box_y1, box_x2, box_y2 =  830,774,1265,1336
